  ...
  return (
    <div className="max-w-contentContainer mx-auto px-4 py-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mt-10 lgl:px-10">
        <ArchiveCard
          title="University of Sri Jayewardanepura"
          des=" As a third-year student pursuing a BSc Hons in Information Technology in the information and communication department ,
           I'm immersed in exploring various aspects of ICT."
          
          link="https://www.sjp.ac.lk/"
        />
        <ArchiveCard
          title="Anandha Sastralaya National Colledge Mathugama"
          des=" Studied at ASM higher school , completed GCE Advanced Level exam in 2020."
         
          link="https://web.facebook.com/infoasm.lk/?_rdc=1&_rdr"
        />
        <ArchiveCard
